...
function computeSpecChanges(newSpec, oldSpec) {
  ...
  var fieldNames = (0, _getUniqueFieldNames.default)([newSpec, oldSpec]);
  ...
  if ([].concat(fieldNames).some(function (field) {
    return !(field in newSpec) || !(field in oldSpec) || !(0, _fastDeepEqual.default)(newSpec[field], oldSpec[field]);
  })) {
    changes.isExpensive = true;
  }
