...
export function wrapPositionInvalidTest({ fieldDef, channel, markDef, ref }) {
 ...
 */
export function interpolatedSignalRef({ scaleName, fieldDef, fieldDef2, offset, startSuffix, band = 0.5 }) {
