...
export declare function values(specifiedAxis: Axis, model: UnitModel, fieldDef: TypedFieldDef<string>): SignalRef | (string | number | boolean | import("../../datetime").DateTime | {
    signal: string;
})[];
