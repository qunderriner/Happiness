...
export declare function assembleDomain(model: Model, channel: ScaleChannel): SignalRef | (import("vega-typings/types").ScaleDataRef & {
    sort?: VgSortField;
}) | (import("vega-typings/types").ScaleMultiDataRef & {
    sort?: VgSortField;
}) | (import("vega-typings/types").ScaleMultiFieldsRef & {
    sort?: VgSortField;
