import { LabelOverlap, LegendType, SignalRef, SymbolShape } from 'vega-typings';
...
export declare function values(legend: Legend, fieldDef: TypedFieldDef<string>): SignalRef | (string | number | boolean | import("../../datetime").DateTime | {
    signal: string;
})[];
export declare function defaultSymbolType(mark: Mark, channel: Channel, shapeChannelDef: FieldDefWithCondition<MarkPropFieldDef<string>, SymbolShape> | ValueDefWithCondition<MarkPropFieldDef<string>, SymbolShape>, markShape: SymbolShape | SignalRef): SymbolShape | SignalRef;
