import { SymbolEncodeEntry } from 'vega-typings';
...
export declare function entries(fieldDef: TypedFieldDef<string>, entriesSpec: any, model: UnitModel, channel: NonPositionScaleChannel, legendCmp: LegendComponent): {
    fill: {
        value: string;
    };
};
