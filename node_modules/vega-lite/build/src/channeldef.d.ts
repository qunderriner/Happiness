 ...
 */
export declare type ChannelDefWithCondition<F extends FieldDef<any>, V extends ValueOrGradientOrText = Value> = FieldDefWithCondition<F, V> | ValueDefWithCondition<F, V> | SignalRefWithCondition<F, V>;
/**
 ...
 * @hidden
 */
export declare type SignalRefWithCondition<F extends FieldDef<any>, V extends ValueOrGradientOrText = Value> = SignalRef & {
    /**
     * A field definition or one or more value definition(s) with a selection predicate.
     */
    condition?: Conditional<F> | ValueOrSignalCondition<V>;
};
export declare type ValueOrSignalWithCondition<F extends FieldDef<any>, V extends ValueOrGradientOrText = Value> = ValueDefWithCondition<F, V> | SignalRefWithCondition<F, V>;
export declare type StringValueOrSignalWithCondition<F extends Field, T extends Type = StandardType> = ValueOrSignalWithCondition<MarkPropFieldDef<F, T>, string | null>;
export declare type ColorGradientValueOrSignalWithCondition<F extends Field, T extends Type = StandardType> = ValueOrSignalWithCondition<MarkPropFieldDef<F, T>, Gradient | string | null>;
export declare type NumericValueOrSignalWithCondition<F extends Field> = ValueOrSignalWithCondition<MarkPropFieldDef<F, StandardType>, number>;
export declare type NumericArrayValueDefWithCondition<F extends Field> = ValueDefWithCondition<MarkPropFieldDef<F, StandardType>, number[]>;
export declare type TypeForShape = 'nominal' | 'ordinal' | 'geojson';
export declare type ShapeValueOrSignalWithCondition<F extends Field> = StringValueOrSignalWithCondition<F, TypeForShape>;
export declare type TextValueOrSignalWithCondition<F extends Field> = ValueOrSignalWithCondition<StringFieldDef<F>, Text>;
export declare type Conditional<CD extends FieldDef<any> | ValueDef<any> | SignalRef> = ConditionalPredicate<CD> | ConditionalSelection<CD>;
export declare type ConditionalPredicate<CD extends FieldDef<any> | ValueDef<any> | SignalRef> = {
    /**
     * Predicate for triggering the condition
     */
    test: LogicalComposition<Predicate>;
} & CD;
export declare type ConditionalSelection<CD extends FieldDef<any> | ValueDef<any> | SignalRef> = {
    /**
...
export declare type NumericArrayFieldDefWithCondition<F extends Field> = FieldDefWithCondition<MarkPropFieldDef<F, StandardType>, number[]>;
 ...
 */
export declare function valueExpr(v: number | string | boolean | DateTime | SignalRef, { timeUnit, type, time, undefinedIfExprNotRequired }: {
    timeUnit: TimeUnit | TimeUnitParams;
    type?: Type;
    time?: boolean;
